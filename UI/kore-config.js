...
var email;
 ...
 // Provide users email id here
  ...
  getUser().then(
    function (res) {
      ...
      console.log(email);
      botOptions.botInfo.customData.name = res.data[0].name
      botOptions.botInfo.customData.age = res.data[0].age
      botOptions.botInfo.customData.email = email
      botOptions.botInfo.customData.id = res.data[0].id;
 ...
 // console.log(email)
  botOptions.botInfo = {
    name: "TravelPlanner",
    _id: "st-3101255c-1be1-52ca-a35a-8e7ac2df5806",
    customData: { 
    },
  };
 // console.log(botOptions.botInfo)
  /* 
    ...
    **/
  botOptions.clientId = "cs-d57d486c-77dd-577a-954b-88a2316ef76f";
